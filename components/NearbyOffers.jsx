...
const NearbyOffers = ({ navigation, setCurrOffer, setOfferModal }) => {
  ...
  useEffect(() => {
    ...
    const shuffledOfferList = offerList;
  ...
  return (
    <View style={styles.NearbyOffers}>
      <View style={styles.header}>
        ...
        >
          <Text style={{ color: Colors.gray2, fontWeight: 600 }}>
            View more
          </Text>
        </TouchableOpacity>
      </View>
